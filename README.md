...
The server is built with [Tornado](https://www.tornadoweb.org/en/stable/), a scalable, non-blocking web server and framework built to efficiently manage large volumes of simultaneous, long-lived connections.
